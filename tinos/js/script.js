...
function analyzeThemePrompt(prompt) {
    ...
    const colorRules = [
        ...
        {
            key: 'green',
            keywords: ['green', 'nature', 'forest', '綠色', '綠油油', '綠袖子', '翠綠', '草地色', '森系', '放鬆', '平靜', 'hea', '悠閒', '舒服', '生機', '舒坦', '佛系', '清靜'],
            theme: { primary: '#10b981', secondary: '#059669', accent: '#34d399', text: '#ffffff' },
            autoAnim: 'swaying'
        },
        {
            key: 'blue',
            keywords: ['blue', 'ocean', 'water', '藍色', '海洋色', '大海色', '藍藍地', '天藍', '青花瓷', '蔚藍', '深海', '憂鬱', '灰咗', 'emo', '寂寞', '想喊', '頹廢', '心淡', 'sad'],
            theme: { primary: '#3b82f6', secondary: '#1d4ed8', accent: '#60a5fa', text: '#ffffff' },
            autoAnim: 'floating'
        },
        {
            key: 'red',
            keywords: ['red', 'sunset', '紅色', '烈火', '夕陽色', '辣', '熱烈', '紅吱吱', '大紅', '紅卜卜', '火紅', '好嬲', '發火', '火滾', '熱血', '衝勁', '嬲爆爆', '氣炸', '火大', '袂爽', '抓狂'],
            theme: { primary: '#ef4444', secondary: '#dc2626', accent: '#fbbf24', text: '#ffffff' },
            autoAnim: 'shaking'
        },
        {
            key: 'pink',
            keywords: ['pink', 'love', 'romantic', '粉紅', '粉紅色', '少女心', '粉粉地', '粉油抄手', '冧滋滋', '甜蜜', '放閃', '甜到漏', '糖黐豆', '初戀感', '幸福感', '怕醜', '面紅'],
            theme: { primary: '#ec4899', secondary: '#be185d', accent: '#f472b6', text: '#ffffff' },
            autoAnim: 'pulsing'
        },
        {
            key: 'gold',
            keywords: ['gold', 'golden', 'luxury', '金色', '金閃閃', '金爍爍', '奢華感', '高貴', '滿城盡帶黃金甲', '發財色', '富貴', '登樣', '貴氣', '招財', '揪格', '高級感'],
            theme: { primary: '#fbbf24', secondary: '#f59e0b', accent: '#fffbeb', text: '#92400e' },
            autoAnim: 'zooming'
        },
        {
            key: 'silver',
            keywords: ['silver', 'chrome', 'metallic', '銀色', '金屬感', '鋼鐵色', '銀閃閃', '亮銀', '鈦鋼色', '冷酷', '皮皮剉', '畏寒', '孤傲', '冷感'],
            theme: { primary: '#94a3b8', secondary: '#64748b', accent: '#f1f5f9', text: '#1e293b' }
        },
        {
            key: 'rainbow',
            keywords: ['rainbow', 'colorful', 'vibrant', '彩色', '多色', '鮮艷', '七彩', '繽紛', '五彩', '花哩碌', '花喇喇', '開心', '興奮', '爽歪歪', '歡樂', '雀躍', '盞鬼', '好型'],
            theme: { primary: '#ec4899', secondary: '#8b5cf6', accent: '#06ffa5', text: '#ffffff' },
            autoAnim: 'jumping'
        },
        {
            key: 'orange',
            keywords: ['orange', 'autumn', 'warm', '橙色', '秋天感', '暖色系', '夕陽紅', '鹹蛋黃色', '暖洋洋', '溫馨', '朝氣', '陽光', '活力', '親切'],
            theme: { primary: '#f97316', secondary: '#ea580c', accent: '#fed7aa', text: '#ffffff' }
        },
        {
            key: 'black',
            keywords: ['black', 'dark', 'minimal', '黑色', '黑暗風', '暗黑系', '極簡風', '型格', '黑鼆鼆', '墨色', '冷淡風', '沈重', '黑人問號', '懞查查', '霧煞煞', '衰小', '倒霉'],
            theme: { primary: '#000000', secondary: '#1f1f1f', accent: '#ffffff', text: '#ffffff' },
            autoAnim: 'crawling'
        },
        {
            key: 'white',
            keywords: ['white', 'pure', 'clean', '白色', '白雪雪', '純淨感', '簡潔', '雪白色', '白帥帥', '佛系', '空白', '安穩', '素雅', '清爽'],
